...
public class PurgeCommands {
    public PurgeCommands(GuildMessageReceivedEvent event, String[] args) {
        ...
        if (event.getMember().getVoiceState().inVoiceChannel()) {
            ...
            musicManager.purge(event.getGuild());
            event.getChannel().sendMessage("Les sketchs on été purger").queue();
